...
<body>
    ...
    <div class="container px-4 px-lg-5 mt-3">
        ...
        if (isset($_GET['start_date']) && isset($_GET['end_date']) && isset($_GET['book_name'])) {
            ...
            if ($ex_pub->num_rows > 0) {
                ...
                $where = "UPPER(book_name) LIKE UPPER('%$bname%') AND DATE_FORMAT(rec_date, '%Y-%m-%d') BETWEEN '$start_date' AND '$end_date' AND pub_id = '$pubid'
